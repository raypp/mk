...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['sellya_product_custom_content'] = $this->config->get('sellya_product_custom_content' . $this->config->get('config_language_id'));	
			$this->data['sellya_product_custom_tab_title'] = $this->config->get('sellya_product_custom_tab_title' . $this->config->get('config_language_id'));		
			$this->data['sellya_product_custom_tab_content'] = $this->config->get('sellya_product_custom_tab_content' . $this->config->get('config_language_id'));
			$this->data['sellya_product_custom_tab_2_title'] = $this->config->get('sellya_product_custom_tab_2_title' . $this->config->get('config_language_id'));		
			$this->data['sellya_product_custom_tab_2_content'] = $this->config->get('sellya_product_custom_tab_2_content' . $this->config->get('config_language_id'));
			$this->data['sellya_product_custom_tab_3_title'] = $this->config->get('sellya_product_custom_tab_3_title' . $this->config->get('config_language_id'));		
			$this->data['sellya_product_custom_tab_3_content'] = $this->config->get('sellya_product_custom_tab_3_content' . $this->config->get('config_language_id'));			
